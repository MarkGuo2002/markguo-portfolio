...
const CardProject = ( {image, title, description, date, taglist} ) =>{
    ...
    return(
        <>
        <div className="relative flex items-center cursor-pointer card-container max-w-[52rem] bg-hoverGray rounded-xl border-[1px] py-6  border-darkgray h-fit shadow-inner overflow-hidden group hover:shadow-primary hover:brightness-95 transition-all duration-500">
        ...
        <div className="px-4 py-2 bg-primary right-0 bottom-0 absolute rounded-tl-xl rounded-br-xl text-white font-semibold drop-shadow-md
            ...
            <div className="w-full lg:w-6/12 p-12 lg:pr-12 description-container flex flex-col gap-2">
