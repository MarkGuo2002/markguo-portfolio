...
const CardProject = ( {image, title, description, date, taglist, link} ) =>{
    ...
    return(
        ...
        <a href={link} target="_blank" rel="noreferrer">
            ...
            <div className="px-4 py-2 bg-primary right-0 bottom-0 absolute rounded-tl-xl rounded-br-xl text-white font-semibold drop-shadow-md
                            opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 ease-in-out"> More Info → </div>
